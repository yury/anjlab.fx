...
using AnjLab.FX.Wpf.ParticleSystems.Engine;
using AnjLab.FX.Wpf.ParticleSystems.Engine.Controls;
using AnjLab.FX.Wpf.ParticleSystems.Engine.Emitters;
using AnjLab.FX.Wpf.ParticleSystems.Engine.Forces;

namespace AnjLab.FX.Wpf.ParticleSystems.Engine.Controls
{
    public class ParticleSystem : ItemsControl
    {
        ...
        */
        ...
        /// <summary>
        /// Dependency Property which starts or stops particle system animation
        /// </summary>
        public static readonly DependencyProperty StartedProperty = DependencyProperty.Register(
            "Started",
            typeof(bool),
            typeof(ParticleSystem),
            new PropertyMetadata(StartedChanged));
        ...
        private static void StartedChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var system = d as ParticleSystem;
